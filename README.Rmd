---
title: "rtree package"
author: Philipp Hunziker & Kent Johnson
date: "`r Sys.Date()`"
...
[this](http://gallery.rcpp.org/articles/Rtree-examples/) 
...
We first compare the within-distance functionality to the gWithinDistance function offered in [rgeos](https://cran.r-project.org/package=rgeos) (version `r packageVersion('rgeos')`).
